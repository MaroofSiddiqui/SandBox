...
function SubscriptionPlans() {
  ...
  const handleChoosePlan = async (subscription) => {
    ...
    try {
      ...
      /*
       * For our first integration test we are using
       * organization ID 2.
       *
       * We will REMOVE this hardcoding later and
       * obtain organizationId from the logged-in HR.
       */
      ...
      const options = {
        ...
        handler: function (response) {
          ...
          alert(
            "Payment completed. Verification will be added next."
          );
